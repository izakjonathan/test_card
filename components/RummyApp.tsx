  ...
  return (
    <main className="relative h-[100dvh] overflow-hidden">
      <div className="app-bg" aria-hidden="true" />
            <div className="app-ui type-sub mt-1">
              {currentLeader ? `${currentLeader.name} leading` : ""}
            </div>
          </div>
      ...
      <AnimatePresence>
        {settingsOpen && (
          <>
            ...
            />
            <motion.div
              className="glass fixed left-4 right-4 top-[120px] z-[91] rounded-[28px] p-4"
              initial={{ opacity: 0, y: 12, scale: 0.98 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              exit={{ opacity: 0, y: 12, scale: 0.98 }}
            >
              <div className="mb-3 text-center">
                <div className="type-label">Settings</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="glass-soft h-[48px] rounded-[18px] text-[13px] font-[700]"
                >
                  Undo
                </button>
                ...
                <button
                  ...
                  className="glass-soft h-[48px] rounded-[18px] text-[13px] font-[700] text-emerald-200"
                >
                  Save
                </button>
                ...
                <button
                  ...
                  className="glass-soft h-[48px] rounded-[18px] text-[13px] font-[700] text-red-200"
                >
                  Reset
                </button>
              </div>
